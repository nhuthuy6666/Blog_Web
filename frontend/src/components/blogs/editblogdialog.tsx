...
import { Edit3, BookOpen, Sparkles, X, Save } from "lucide-react";
...
export default function EditBlogDialog({ blogId, blog, open, onOpenChange }: EditBlogDialogProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 mt-1">Cập nhật nội dung và ý tưởng của bạn</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          {(title || content) && (
            <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-xl p-3">
              <p className="text-xs text-slate-600 flex items-center space-x-1">
                ...
                <span>Bài viết của bạn đang được chỉnh sửa... {title && content ? 'Sẵn sàng cập nhật!' : 'Cần thêm thông tin.'}</span>
              </p>
            </div>
          )}
        </div>
